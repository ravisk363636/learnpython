...
This repo is to learn Python from scratch by building **real products**, not only syntax drills.

## Start here

1. Read [prompts/real-life-product-ideas.md](prompts/real-life-product-ideas.md) — 12 real-world problems you can turn into software.
